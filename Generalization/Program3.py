...
def converge_success(samples, search_params, epoch):
    ...
    optimizer = optim.SGD(gausslist.parameters(), lr=0.1 / len(search_params), momentum=0.001)
...
def exp_convergence():
    ...
    guesses1, execution1, llh1 = converge_success(samples, search_params, 10)
